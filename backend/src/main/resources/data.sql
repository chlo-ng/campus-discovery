...
INSERT INTO events (title, event_date, start_time, description, invite_only, location, capacity, image, creator_id) VALUES
   ('VSA Moonfest', '2022-10-13', '18:00:00', 'Free food, prizes, and performances', TRUE, 'Tech Green', 10,
   ...
   ('HackGT', '2022-10-21', '19:00:00', 'Gt''s annual 36-hour hackathon event', TRUE, 'Klaus', 12,
   'https://2022.hack.gt/img/main/logo/hackgt9logo.png', 2),
   ('Seoulstice Showcase', '2022-11-30', '18:30:00', 'Kpop dance performances by GT''s kpop dance team', FALSE, 'Klaus Atrium', 20,
   ...
   ('CSA Kickball Tournament', '2022-10-29', '15:00:00', 'Come compete against other teams! Winner gets prizes',  FALSE, 'Burger Bowl Field', 5,
   'https://d1fdloi71mui9q.cloudfront.net/NMgs240RlqYTL9g2qVPg_8sMLFUswP06DHFoS', 4),
   ('China Care Cure Your Cravings', '2022-11-11', '18:30:00', 'Support education and care of vulnerable Asian children. Presale: $6',  FALSE, 'Klaus Atrium', 35,
   ...
   ('AASA Tour of Asia', '2022-11-04', '18:00:00', 'Free food, photo booths, portrait artists, and fun activities by cultural organizations',  FALSE, 'Tech Green', 2,
   'https://diversityprograms.gatech.edu/sites/default/files/hg_media/Newsletter%20Header%20%281%29.jpg', 2),
   ('GTIA Night Market', '2022-11-03', '18:00:00', 'Come enjoy a night of music, food, art, and traditions featured by cultural organizations', FALSE, 'Tech Green', 6,
   ...
   ('FSA GBM Dance Workshop', '2022-11-07', '18:00:00', 'Get groovy and dance with us at our next GBM', TRUE, 'Home Park at Exhibition Hall', 13,
   'https://se-images-blob.campuslabs.com/documents/5429/70a6c90a-bac0-43ba-d99a-08d95f47a41f/1500.png', 4),
   ('WACC Resume Review', '2022-10-27','18:30:00', 'Join Meta this week for resume review, swag, and free food', TRUE, 'CoC 102', 14,
   ...
   ('SCPC Fall Concert', '2022-10-22', '19:00:00', '2022 Fall Concert featuring student openers and a nationally-recognized artist!', TRUE, 'Tech Green', 6,
   'https://www.concertarchives.org/image_uploads/photo/image/505104/large_image.jpg', 2),
   ('KUSA Fall Mixer', '2022-10-21', '17:00:00', 'First fall mixer with music by Alex Heisey', FALSE, 'Student Center', 17,
