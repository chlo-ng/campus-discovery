        ...
        <main>
          ...
          <div className="container">
            ...
            <div className={styles.eventsContainer}>
              ...
              <div className={`${styles.searchBar} input-group rounded`}>
                <input type="search" className="form-control rounded" placeholder="Start browsing..." aria-label="Search" aria-describedby="search-addon" size={50} />
                <span className={`${styles.searchIcon} input-group-text border-0`} id="search-addon">
