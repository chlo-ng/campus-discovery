      ...
      <div>
        ...
        <main>
          ...
          <div className={styles.eventsContainer}>
            ...
            <div className={styles.trending}>
              <div className={styles.verticalCenter}>
                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="currentColor" class="bi bi-caret-left" viewBox="0 0 16 16">
          ...
          <div className={styles.eventsContainer}>
            ...
            <div className={styles.searchBar} class="input-group rounded">
              <input type="search" class="form-control rounded" placeholder="Start browsing..." aria-label="Search" aria-describedby="search-addon" size="50" />
              <span className={styles.searchIcon} class="input-group-text border-0" id="search-addon">
